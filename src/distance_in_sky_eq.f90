!> \file distance_in_sky_eq.f90  Calculate the angular distance between two positions on a stellar globe, in equatorial
!!                               coordinates
...
!***********************************************************************************************************************************
!> \brief  Calculate the angular distance between two positions on a stellar globe, in equatorial coordinates

program distance_in_sky_eq
  use SUFR_kinds, only: double
  use SUFR_constants, only: d2r,r2d,h2r
  ...
  write(*,'(/,A)') '  Calculate the angular distance between two positions on a stellar globe, in equatorial coordinates'
  ...
  write(*,*) ''
  write(*,'(2x,A,7x,A,F18.6,A)') 'Separation: ',dmss(dist), dist*r2d,' d'
  write(*,'(/)')
